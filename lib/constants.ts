...
export const PAGE_DESCRIPTION =
  '네이버 블로그 검색 노출, 제목·키워드, 썸네일 문구와 CTR을 다루는 실전 가이드 허브입니다. 가이드를 읽고 같은 스타일로 썸네일을 만들 수 있는 무료 도구도 함께 제공합니다.';
export const PAGE_KEYWORDS =
  '네이버 블로그 CTR, 블로그 검색 노출, 키워드 전략, 썸네일 문구, 블로그 제목 작성법, 네이버 블로그 SEO, 블로그 조회수, 썸네일 만들기';
