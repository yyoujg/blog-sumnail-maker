export const PAGE_TITLE = 'BlogKit — 네이버 블로그 CTR·검색유입·썸네일 전략 가이드';
export const PAGE_DESCRIPTION =
  '네이버 블로그 검색 노출, 제목·키워드, 썸네일 문구와 CTR을 다루는 실전 가이드 허브입니다. 가이드를 읽고 같은 스타일로 썸네일을 만들 수 있는 무료 도구와 블로그 스킨·위젯을 디자인하는 스킨메이커도 함께 제공합니다.';
...
export const FONTS = [
  ...
  { name: '잘난고딕', value: `'JalnanGothic', sans-serif` },
  ...
  { name: '써라운드', value: `'Cafe24Surround', sans-serif` },
  { name: '쿠키런', value: `'CookieRun', sans-serif` },
  { name: '티머니 둥근바람', value: `'TMoneyRoundWind', sans-serif` },
  { name: '어그로', value: `'SBAggro', sans-serif` },
  { name: '모바일POP', value: `'OneMobilePop', sans-serif` },
  { name: '단감아삭', value: `'CWDangamAsac', sans-serif` },
  { name: '을지로', value: `'BMEuljiro', sans-serif` },
  { name: '페이퍼로지', value: `'Paperlogy', sans-serif` },
  { name: '손글씨 펜', value: `'Nanum Pen Script', cursive` },
  { name: '손글씨 박다현', value: `'OwnglyphParkDaHyun', cursive` },
