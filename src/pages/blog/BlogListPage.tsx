            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors mb-2">
                    {post.title}
                  </h2>
                ...
                <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-indigo-500 flex-shrink-0 mt-1 transition-colors" />
              </div>
            </Link>
          ))}
        </div>
