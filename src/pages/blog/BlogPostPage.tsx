  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        <Link
          to="/blog"
          className="text-indigo-600 hover:underline text-sm mb-6 inline-flex items-center gap-1"
        >
        ...
        <article>
          <header className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed border-l-4 border-indigo-300 pl-4 bg-indigo-50 py-3 rounded-r-lg">
              {post.summary}
            </p>
          </header>
        ...
        <div className="mt-8 p-5 bg-indigo-50 rounded-xl border border-indigo-100 text-center">
