...
export const metadata: Metadata = {
  ...
  keywords:
    '스킨메이커, 네이버 블로그 스킨, 블로그 스킨 만들기, 블로그 스킨 디자인, 투명 위젯, 블로그 위젯 만들기, 블로그 꾸미기, 무료 블로그 스킨, 블로그 스킨 다운로드, 네이버 스킨 메이커',
  alternates: {
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      '내 메뉴 > 꾸미기 설정 > 스킨 선택 > 디자인 사용 설정에서 "상단 영역" 이미지를 교체하고, 같은 페이지의 "타이틀" 영역도 직접 만든 스킨 이미지로 교체해 적용합니다. 위젯도 동일 메뉴에서 PNG로 업로드합니다.',
  },
  {
