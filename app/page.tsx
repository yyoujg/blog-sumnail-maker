...
const STYLE_PRESETS = [
  ...
  },
  {
    ...
    bgType: 'image' as BgType,
    bgColor: '#2d3436',
    bgImage: '/images/251217포트웰브/포트웰브_에펠탑코너.JPG',
    textColor: '#ffffff',
    fontFamily: `'Nanum Myeongjo', serif`,
  ...
  },
  {
    ...
    bgType: 'image' as BgType,
    bgColor: '#1a1a1a',
    bgImage: '/images/260321시온뮤직 수원권선점/시온뮤직-수원권선점-기타전시벽.JPG',
    textColor: '#ffffff',
...
export default function HomePage() {
  ...
  const [bgImage, setBgImage] = useState<string | null>('/images/260320일상엔베이커리/일상엔-수원역카페-소나무조명.JPG');
