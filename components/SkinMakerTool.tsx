...
const BLOG_TEMPLATES: BlogTemplate[] = [
  ...
  },
  {
    ...
    desc: '제품 리뷰·체험단',
    bg: '#1a1a1a',
    bgImage: '/images/260313코어바디필라테스/IMG_8454.JPG',
    bgOverlay: 50,
    bgPosition: 'center 35%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '체험단 & 서비스 솔직 후기', x: 640, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '직접 경험하고 솔직하게 기록합니다 ✔️', x: 760, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.80)', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    desc: '일상·여행·취미',
    bg: '#1a1a1a',
    bgImage: '/images/260317야옹이네고양이카페/IMG_8557.JPG',
    bgOverlay: 38,
