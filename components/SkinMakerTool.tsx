...
const BLOG_TEMPLATES: BlogTemplate[] = [
  {
    ...
    desc: '맛집·카페·레시피',
    bg: '#1a1a1a',
    bgImage: '/images/260208에디션엠/에디션엠-혜화역카페-내부인테리어.JPG',
    bgOverlay: 42,
    bgPosition: 'center 35%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '감성 카페 & 맛집 블로그', x: 660, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '새로운 곳을 찾아 오늘도 탐방합니다 🍽️', x: 740, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.75)', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    desc: '제품 리뷰·체험단',
    bg: '#1a1a1a',
    bgImage: '/images/260124포인핸드서울숲점/12_음료_아이스라떼_강아지배경.JPG',
    bgOverlay: 50,
    bgPosition: 'center center',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '체험단 솔직 후기', x: 730, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '광고 없이 직접 써본 진짜 기록 ✔️', x: 780, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.75)', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    desc: '주식·부동산·절약',
    bg: '#0a2540',
    bgImage: '/images/260320일상엔베이커리/일상엔-수원역카페-격자창-테라스뷰.JPG',
    bgOverlay: 62,
    bgPosition: 'center 40%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '재테크 실전 기록', x: 700, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '주식·부동산·절약 정보를 직접 경험하고 기록합니다 📊', x: 630, y: 210, fontSize: 16, color: '#94a3b8', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    desc: '일상·여행·취미',
    bg: '#1a1a1a',
    bgImage: '/images/260317야옹이네고양이카페/IMG_8545.JPG',
    bgOverlay: 40,
    bgPosition: 'center 30%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '나의 일상 & 취미 기록', x: 670, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '소소하지만 특별한 하루하루를 기록합니다 ☀️', x: 730, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.75)', fontWeight: 'normal' },
    ],
    rects: [
