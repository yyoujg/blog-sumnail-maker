...
const BLOG_TEMPLATES: BlogTemplate[] = [
  {
    ...
    desc: '맛집·카페·레시피',
    bg: '#1a1a1a',
    bgImage: '/images/260320일상엔베이커리/일상엔-대나무정원-로스터리카페뷰.JPG',
    bgOverlay: 38,
    bgPosition: 'center 45%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '감성 카페 & 맛집 기록', x: 680, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '분위기부터 맛까지 솔직하게 기록합니다 🍽️', x: 740, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.80)', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    elements: [
      ...
      { id: 2, type: 'text', text: '광고 없이 직접 써본 진짜 기록 ✔️', x: 760, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.80)', fontWeight: 'normal' },
    ],
    rects: [
  ...
  },
  {
    ...
    desc: '일상·여행·취미',
    bg: '#1a1a1a',
    bgImage: '/images/260314스탠딩코미디광교/스탠드업코미디_배우전체인사1.JPG',
    bgOverlay: 45,
