...
const BLOG_TEMPLATES: BlogTemplate[] = [
  ...
  },
  {
    ...
    desc: '일상·여행·취미',
    bg: '#1a1a1a',
    bgImage: '/images/260124포인핸드서울숲점/10_강아지_두마리침대.JPG',
    bgOverlay: 42,
    bgPosition: 'center 45%',
    cw: 1920, ch: 450,
    elements: [
      { id: 1, type: 'text', text: '나의 일상 & 반려동물 기록', x: 650, y: 135, fontSize: 52, color: '#ffffff', fontWeight: 'bold' },
      { id: 2, type: 'text', text: '함께하는 하루하루가 소중한 기록이 됩니다 🐾', x: 700, y: 210, fontSize: 18, color: 'rgba(255,255,255,0.80)', fontWeight: 'normal' },
    ],
    rects: [
      { id: 101, x: 525, y: 360, w: 170, h: 60, url: 'https://', label: '일상 기록', labelColor: '#ffffff' },
      { id: 102, x: 700, y: 360, w: 170, h: 60, url: 'https://', label: '반려동물', labelColor: '#ffffff' },
      { id: 103, x: 875, y: 360, w: 170, h: 60, url: 'https://', label: '동물 카페', labelColor: '#ffffff' },
